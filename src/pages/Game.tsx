...
function WaitingForOpponent() {
  ...
  const blinksUrl = `${window.location.origin}/api/actions/challenge?matchId=${match.matchId.toString()}&stake=${match.stakeSOL}&asset=${ASSET_NAMES[match.asset]}&playerA=${match.playerA ?? ''}`;
